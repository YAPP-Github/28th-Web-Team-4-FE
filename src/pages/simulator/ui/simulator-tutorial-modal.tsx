...
const TUTORIAL_SLIDES: readonly [TutorialSlide, ...TutorialSlide[]] = [
  {
    ...
    imageSrc: '/simulator-assets/tutorial/add-channels.svg',
  },
  {
    id: 'adjust-budget',
    ...
    imageSrc: '/simulator-assets/tutorial/adjust-budget.svg',
  },
  {
    id: 'save-result',
    title: '추천된 결과를 마이페이지에 저장해요',
    description: ['우측 상단의 결과 저장하기 버튼을 누르면', '마이페이지에 저장할 수 있어요.'],
    imageSrc: '/simulator-assets/tutorial/save-result.svg',
  },
];
