...
export function HomeServiceFinder(): JSX.Element {
  ...
  return (
    <VStack
      as="section"
      aria-label="맞춤 채널 찾기"
      className="bg-surface-lowest relative w-full justify-start overflow-hidden pt-[60px] pb-[100px] sm:pt-[80px] sm:pb-[120px] lg:pt-[100px] lg:pb-[140px]"
    >
      ...
      <VStack className="px-016 sm:px-032 relative z-10 mx-auto w-full max-w-[1200px] gap-[36px] sm:gap-[44px] lg:gap-[52px] lg:px-120">
        {/* 상단 타이포그래피 헤더 */}
        <VStack className="gap-[6px] text-center sm:gap-[8px]">
        ...
        <HStack
          ...
          className="relative h-[58px] w-full max-w-[480px] rounded-full p-[2px] shadow-[0_4px_24px_rgba(255,104,23,0.14)] transition-all focus-within:scale-[1.01] focus-within:shadow-[0_8px_32px_rgba(255,104,23,0.26)] sm:h-[60px]"
          style={{
            backgroundImage:
        ...
        >
          ...
          <JustifyBetween className="bg-surface-lowest relative z-10 size-full items-center rounded-full pr-[10px] pl-[22px] sm:pr-[12px] sm:pl-[26px]">
            ...
            <Center
              ...
              disabled={!canSubmit}
              aria-label="추천 시작하기"
              className="bg-sys-primary-default hover:bg-sys-primary-high focus-visible:outline-sys-primary-default size-[36px] shrink-0 cursor-pointer rounded-full text-white shadow-sm transition-all outline-none active:scale-95 disabled:cursor-not-allowed disabled:opacity-40"
            >
