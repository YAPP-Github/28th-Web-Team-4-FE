...
const contentClassName = [
  ...
  'transition-[translate,opacity] duration-180 ease-out',
  'data-ending-style:[translate:-50%_calc(-50%+8px)] data-ending-style:opacity-0',
  'data-starting-style:[translate:-50%_calc(-50%+8px)] data-starting-style:opacity-0',
  'motion-reduce:transition-none',
].join(' ');
