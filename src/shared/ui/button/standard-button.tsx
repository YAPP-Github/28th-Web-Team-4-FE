...
const standardButtonVariants = cva(buttonBaseClassName, {
  variants: {
    tone: {
      ...
      stroke:
        'bg-btn-sub-low text-text-high border border-btn-sub-selected gap-006 h-11 px-020 py-010 hover:not-data-disabled:opacity-80 focus-within:not-data-disabled:opacity-80 active:not-data-disabled:bg-btn-sub active:not-data-disabled:opacity-100',
      social:
        'bg-btn-sub-low text-text-high border border-outline-default w-full h-[50px] gap-012 hover:not-data-disabled:bg-btn-sub hover:not-data-disabled:opacity-80 focus-within:not-data-disabled:bg-btn-sub focus-within:not-data-disabled:opacity-80 active:not-data-disabled:bg-btn-sub-selected active:not-data-disabled:opacity-100',
    },
    size: {
      s: '',
      m: '',
