...
import { ChannelDetailModalHeaderQuery } from '@/features/channel-detail/ui/channel-detail-modal-header-query';
...
export function openChannelDetailModal({
  ...
  return openChannelDetailOverlay({
    children: (
      <>
        <ChannelDetailModalHeaderQuery channel={channel} onboardingId={onboardingId} />
