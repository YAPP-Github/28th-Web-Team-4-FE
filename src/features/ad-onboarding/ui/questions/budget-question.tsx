...
function commitBudgetRangeChange(
  ...
  onInputRangeChange: (inputRange: CommonOnboardingDraft['budgetInputRange']) => void,
): void {
  onRangeChange(range);
 ...
 */
function getBudgetInputRange(range: BudgetRange): CommonOnboardingDraft['budgetInputRange'] {
  return {
