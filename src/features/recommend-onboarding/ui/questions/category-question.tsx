...
import { CATEGORY_OPTION_LIST } from '@/features/recommend-onboarding/model/recommend-onboarding-options';
import type { OnboardingDraft } from '@/features/recommend-onboarding/model/recommend-onboarding-state';
import { SelectChip } from '@/features/recommend-onboarding/ui/select-chip';
