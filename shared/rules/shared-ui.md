---
description: shared/ui·Storybook·cn/layout 재사용. Figma는 docs/architecture.md
alwaysApply: false
globs:
  - src/shared/ui/**
  - src/**/*.stories.*
claudeFile: 20-shared-ui.md
---
...
- `cn`·layout을 재사용하고, Layout 선택·불변 속성은 루트 `shared/rules/ui-layout.md`를 따른다. 텍스트는 Text 컴포넌트 또는 `typo-*` (`src/styles/tokens/typography.css`).
